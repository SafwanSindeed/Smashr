export const MOCK_TOURNAMENTS = [
  {
    ...
    totalPlayers: 38,
    description:
      "Kick off the summer season at Riverside Park with NYC's premier singles tournament for intermediate to advanced players. Compete on professional courts with referees and live scoring.",
  },
  {
    id: "t2",
    name: "Brooklyn Doubles Showdown",
    format: "D",
    ...
    totalPlayers: 18,
    description:
      "Partner up and battle it out at McCarren Park in this exciting doubles format open to recreational and club-level players. Entry fee covers both players and includes post-tournament social.",
  },
  {
    id: "t3",
    name: "Queens Summer Series Pro",
    format: "S",
    ...
    totalPlayers: 41,
    description:
      "An elite singles event at Flushing Meadows designed for high-level competitors looking to test their skills against the best in the NYC region. Round-robin pool play followed by single-elimination brackets.",
  },
  {
    id: "t4",
    name: "Bronx Mixed Open League",
    format: "D",
    ...
    totalPlayers: 22,
    description:
      "A one-day mixed doubles league event at Van Cortlandt Park welcoming beginner to intermediate teams in a fun, social atmosphere. All matches are guaranteed regardless of round-robin results.",
  },
  {
    id: "t5",
    name: "Smashr NYC Championship",
    format: "S",
    ...
    totalPlayers: 29,
    description:
      "Smashr's signature annual NYC championship draws competitors from across the five boroughs for two days of intense singles play at Central Park. Cash prizes awarded to top finishers in each skill bracket.",
  },
];
...
export function getMockSessions() {
  ...
  [0, 1, 2, 3, 4, 5, 6].forEach((day) => {
    sessions.push({
      ...
      maxSpots: 30,
      description:
        "Drop-in open play for intermediate players at Central Park. Courts are reserved exclusively for Smashr members and guests. Rally format with rotating partners keeps games moving.",
